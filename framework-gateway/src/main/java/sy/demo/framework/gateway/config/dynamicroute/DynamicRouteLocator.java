...
package sy.demo.framework.gateway.config.dynamicroute;
...
import sy.demo.framework.gateway.entity.SysZuulRoute;
import sy.demo.framework.gateway.mapper.RouteMapper;
